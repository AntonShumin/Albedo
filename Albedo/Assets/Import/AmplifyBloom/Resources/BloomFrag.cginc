...
half4 frag_BokehFiltering ( v2f_img input ) : SV_Target
{
	...
	samplePixel = tex2D ( _MainTex, sampleCoords );
...
{
	return min ( tex2D ( _MainTex,input.uv ) , tex2D ( _AnamorphicRTS0, input.uv ) );
}

half4 frag_BokehComposition3S ( v2f_img input ) : SV_Target
{
	half4 colorMinA = min ( tex2D ( _MainTex,input.uv ) , tex2D ( _AnamorphicRTS0, input.uv ) );
	return min ( colorMinA,tex2D ( _AnamorphicRTS1,input.uv ) );
}

half4 frag_BokehComposition4S ( v2f_img input ) : SV_Target
{
	half4 colorMin = min ( tex2D ( _MainTex,input.uv ) , tex2D ( _AnamorphicRTS0, input.uv ) );
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS1, input.uv ) );
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS2, input.uv ) );
	return colorMin;
}
...
half4 frag_BokehComposition5S ( v2f_img input ) : SV_Target
{
	...
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS1, input.uv ) );
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS2, input.uv ) );
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS3, input.uv ) );
	return colorMin;
}
...
half4 frag_BokehComposition6S ( v2f_img input ) : SV_Target
{
	...
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS2, input.uv ) );
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS3, input.uv ) );
	colorMin = min ( colorMin, tex2D ( _AnamorphicRTS4, input.uv ) );
	return colorMin;
}
...
half4 frag_weightedAddPS1 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights0 * DecodeColor ( tex2D ( _AnamorphicRTS0, input.uv ) );
...
half4 frag_weightedAddPS2 ( v2f_img input ) : SV_Target
{
	half3 vColor = half3( 0,0,0 );
	vColor += _AnamorphicGlareWeights0 * DecodeColor ( tex2D ( _AnamorphicRTS0, input.uv ) );
	vColor += _AnamorphicGlareWeights1 * DecodeColor ( tex2D ( _AnamorphicRTS1, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_weightedAddPS3 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights0 * DecodeColor ( tex2D ( _AnamorphicRTS0, input.uv ) );
	vColor += _AnamorphicGlareWeights1 * DecodeColor ( tex2D ( _AnamorphicRTS1, input.uv ) );
	vColor += _AnamorphicGlareWeights2 * DecodeColor ( tex2D ( _AnamorphicRTS2, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_weightedAddPS4 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights1 * DecodeColor ( tex2D ( _AnamorphicRTS1, input.uv ) );
	vColor += _AnamorphicGlareWeights2 * DecodeColor ( tex2D ( _AnamorphicRTS2, input.uv ) );
	vColor += _AnamorphicGlareWeights3 * DecodeColor ( tex2D ( _AnamorphicRTS3, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_weightedAddPS5 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights2 * DecodeColor ( tex2D ( _AnamorphicRTS2, input.uv ) );
	vColor += _AnamorphicGlareWeights3 * DecodeColor ( tex2D ( _AnamorphicRTS3, input.uv ) );
	vColor += _AnamorphicGlareWeights4 * DecodeColor ( tex2D ( _AnamorphicRTS4, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_weightedAddPS6 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights3 * DecodeColor ( tex2D ( _AnamorphicRTS3, input.uv ) );
	vColor += _AnamorphicGlareWeights4 * DecodeColor ( tex2D ( _AnamorphicRTS4, input.uv ) );
	vColor += _AnamorphicGlareWeights5 * DecodeColor ( tex2D ( _AnamorphicRTS5, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_weightedAddPS7 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights4 * DecodeColor ( tex2D ( _AnamorphicRTS4, input.uv ) );
	vColor += _AnamorphicGlareWeights5 * DecodeColor ( tex2D ( _AnamorphicRTS5, input.uv ) );
	vColor += _AnamorphicGlareWeights6 * DecodeColor ( tex2D ( _AnamorphicRTS6, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_weightedAddPS8 ( v2f_img input ) : SV_Target
{
	...
	vColor += _AnamorphicGlareWeights5 * DecodeColor ( tex2D ( _AnamorphicRTS5, input.uv ) );
	vColor += _AnamorphicGlareWeights6 * DecodeColor ( tex2D ( _AnamorphicRTS6, input.uv ) );
	vColor += _AnamorphicGlareWeights7 * DecodeColor ( tex2D ( _AnamorphicRTS7, input.uv ) );
	return EncodeColor ( vColor );
}
...
half4 frag_downsampler_temp_filter_with_karis ( v2f_img input ) : SV_Target
{
	...
	half4 prevColor = tex2D ( _AnamorphicRTS0, input.uv );
...
{
	return ( tex2D ( _MainTex, input.uv ) + tex2D ( _AnamorphicRTS0, input.uv ) );
}
